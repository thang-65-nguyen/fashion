...
const AllProductQuanDai = () => {
  ...
  const loadProduct = async () => {
    const result = await axios.get("http://localhost:8000/Quan_dai");
        ...
        <div className="container">
          <div className="row">
            <ul className="nav-product">
              ...
              <li>
                <a href="#"> Bottoms | Skirt | Pants</a>
              </li>

              <li>
                <a href="/all_productQuanDai">Quần dài</a>
              </li>
            </ul>
          </div>
        </div>
                ...
                <div id="demo" className="collapse">
                  ...
                  <ul>
                    <li>
                      ...
                      <Link to="/all_product">Individual Sets</Link>
                    </li>
                  </ul>
                  <ul>
                    <li>
                    ...
                    return (
                      <div className="product-allsp">
                        <div className="product-img">
                          <img src={products.image} alt="true" />
                          <img
...
export default AllProductQuanDai;
