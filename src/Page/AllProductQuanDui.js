...
const AllProductQuanDui = () => {
  ...
  const loadProduct = async () => {
    const result = await axios.get(" http://localhost:8000/Quan_Dui");
        ...
        <div className="container">
          <div className="row">
            <ul className="nav-product">
              ...
              <li>
                <a href="/all_productQuanDui">Quần đùi</a>
              </li>
            </ul>
          </div>
        </div>
              ...
              >
                ...
                <div id="demo" className="collapse">
                  <ul>
                    ...
                    <li>
                      <Link to="/all_productCardigan">Áo len</Link>
                    </li>
                  </ul>
                  <ul>
                    <li>
...
export default AllProductQuanDui;
