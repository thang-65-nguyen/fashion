...
const AllProductCardigan = () => {
  ...
  const loadProduct = async () => {
    const result = await axios.get("http://localhost:8000/Cardigan");
        ...
        <div className="container">
          <div className="row">
            <ul className="nav-product">
              ...
              <li>
                <a href="/all_productCardigan">Cardigan</a>
              </li>
            </ul>
          </div>
        </div>
...
export default AllProductCardigan;
