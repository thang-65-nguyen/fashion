...
const Describe_Cardigan = () => {
  ...
  useEffect(() => {
    fetch("http://localhost:8000/Cardigan/" + empid)
      .then((res) => {
        return res.json();
      })
      .then((resp) => {
          ...
          <div className="container">
            <div className="row">
              <ul className="nav-product-describe" style={{ marginTop: 10 }}>
                ...
                <li>
                  <Link to="/all_product">Tất cả sản phẩm</Link>
                </li>
                <li className="text-primary">Set đồ nam nữ thể thao</li>
              </ul>
            </div>
          </div>
        </div>
            ...
            <div className="col">
              ...
              <div className="product-grid-Describe">
                ...
                <div className="product">
                  ...
                  <div className="product-info">
                    <div>
                      <span className="product-name">Croptop lưới</span>
                      <span className="product-price">$ 188.000 </span>
                    </div>
                    <hr />
                    <a href="#" className="product-btn">
                      Buy now
                ...
                <div className="product">
                  ...
                  <div className="product-info">
                    <div>
                      <span className="product-name">Áo thun nam</span>
                      <span className="product-price">$ 295.000 </span>
                    </div>
                    <hr />
                    <a href="#" className="product-btn">
                      Buy now
...
export default Describe_Cardigan;
